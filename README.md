...
The Sign-In/Sign-Up view is pretty straight forward. Component's own states are maintained to display forms. Using google sign in an user can sign in to the app. Using the Firebase Authentication an user can use his email address to create a new account and later he can sign in with his username and password credentials. 
...
The Home View is consists of four tabs -
 ...
 - Camera Scan for visa
 - Information about the visa

The "Universal Scan" component is a camera view with "tap to focus" functionality by using the focus control. All the data are coming from Firebase NoSQL database.
...
* Ability to change the name and address of the user.
